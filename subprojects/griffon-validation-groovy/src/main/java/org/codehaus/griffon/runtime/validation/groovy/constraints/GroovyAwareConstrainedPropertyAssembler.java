 ...
 */
package org.codehaus.griffon.runtime.validation.groovy.constraints;
...
import static griffon.util.TypeUtils.castToChar;
...
import static griffon.util.TypeUtils.isCharacter;
import static griffon.util.TypeUtils.isDouble;
import static griffon.util.TypeUtils.isFloat;
import static griffon.util.TypeUtils.isInteger;
import static griffon.util.TypeUtils.isLong;
            ...
            if (cp.getPropertyType() == null) {
                if (!IMPORT_FROM_CONSTRAINT.equals(name)) {
                    if (LOG.isWarnEnabled()) {
                        LOG.warn("Property [" + cp.getPropertyName() + "] not found in class " +
